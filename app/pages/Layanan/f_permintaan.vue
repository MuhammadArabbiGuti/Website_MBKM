<template>
    <div class="form-container">
      <h2>Formulir Perminataan Layanan</h2>
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="form-group">
          ...
          <input
            ...
            id="ktp"
            v-model="form.ktp"
            placeholder="Mohon masukkan nomor Kartu Tanda Penduduk."
            required
          />
        </div>
        ...
        <div class="form-group">
          ...
          <textarea
            id="pesan"
            v-model="form.pesan"
            placeholder="Tulis isi pesan yang ingin Anda sampaikan."
            required
          ></textarea>
        </div>
  ...
  const handleSubmit = () => {
    ...
    form.value = { nama: '', ktp: '', email: '',  kategori:'', pesan: '',  }
  }
  </script>
